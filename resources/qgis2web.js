...
map.getView().fit([-13569933.212612, 4451765.576037, -13566502.670359, 4454502.339562], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Mt Bache Loma Prieta Plus</h2>';
        return titleElement;
    })(),
